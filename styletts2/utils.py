...
def inference(text, ref_s, model, sampler, textclenaer, to_mel, device, model_params, global_phonemizer, alpha=0.3, beta=0.7, diffusion_steps=5, embedding_scale=1):
    text = text.strip()
